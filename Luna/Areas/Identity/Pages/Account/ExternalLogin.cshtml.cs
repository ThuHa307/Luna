    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    //Nếu email đó đã đc đky tài khoản và tài khoản đó muốn liên kết đăng nhập với email đó
                    ...
                    else //Nếu email đó đã đc đky tài khoản và tài khoản email muốn liên kết nhưng đã đc đky với user khác
                    {
                        ModelState.AddModelError(string.Empty, "Lỗi. Vui lòng chọn email khác để liên kết.");
                        return Page();
                    }
                }
